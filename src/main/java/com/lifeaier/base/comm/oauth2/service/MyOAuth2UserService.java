package com.lifeaier.base.comm.oauth2.service;

import com.lifeaier.base.comm.oauth2.dto.FacebookResponse;
import com.lifeaier.base.comm.oauth2.dto.GoogleReponse;
import com.lifeaier.base.comm.oauth2.dto.MyOAuth2User;
import com.lifeaier.base.comm.oauth2.dto.OAuth2Response;
...
import com.lifeaier.base.comm.utility.DownloadUtil;
...
public class MyOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
    	...
    	try {
    		if(pictureUrl != null) {
    			pictureBytes = DownloadUtil.downloadImage(pictureUrl);
    		}			
		} catch (IOException e) {
			e.printStackTrace();
		}
